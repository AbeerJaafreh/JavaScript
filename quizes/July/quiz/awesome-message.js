...
var firstName=" Julia. ",interest=" cats. ",hoppy=" play video games. ";
var awesomeMessage="Hi, ";
console.log(awesomeMessage+"my name is "+firstName+"I love "+interest+"In my spare time ,I like to "+hoppy);